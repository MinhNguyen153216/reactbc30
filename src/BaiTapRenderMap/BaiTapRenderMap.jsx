...
export default class BaiTapRenderMap extends Component {
    ...
    return data.map((film, index) => {
      return (
        <div className="col-2 mt-2" key={index}>
          <div className="card">
            <img src={film.hinhAnh} alt="..." height={400} />
            <div className="card-body bg-dark text-white text-center">
              <h2 className="card-title" style={{ height: 75, fontSize: 25 }}>
                {film.tenPhim}
              </h2>
  ...
  render() {
    return (
      <div style={{ backgroundImage: `url(./img/background/avanger.jpg)` }}>
        <div style={{ minHeight: "100vh", background: "rgba(0,0,0,0.5)" }}>
          <nav
            className="navbar navbar-expand-sm navbar-dark"
            style={{ background: "rgba(110,203,200,0.9)" }}
          >
